...
int searchNode(tree t, int key); //Searches the BST for a node containing the specified key. It returns a pointer to the found node or NULL if the key does not exist in the tree
